...
class SquareShape3D(origin: Vec3, side1: Vec3, side2: Vec3, tbl: Vec2 = Vec2(), ttr: Vec2 = Vec2(1)): IndicesShape(createVertices(origin, side1, side2, tbl, ttr), intArrayOf(3, 2), intArrayOf(0, 1, 2, 0, 2, 3)) {

    override val shape: Shape = Rect3D(bl, Vec3(15, getVertices()) - bl, Vec3(5, getVertices()) - bl)
