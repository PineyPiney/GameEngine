...
class CollisionBox3DRenderer(val obj: GameObject, val colour: Vec4 = Vec4(1f), val shader: Shader = defaultShader): GameObject() {
    ...
    override fun addComponents() {
        super.addComponents()
        components.add(object : RenderedComponent(this@CollisionBox3DRenderer, shader) {

            val vShape = VertexShape.centerCubeShape
    ...
    companion object{
        val defaultShader = ShaderLoader.getShader(ResourceKey("vertex/pass_pos_3D"), ResourceKey("fragment/collider3D"))
    }
}