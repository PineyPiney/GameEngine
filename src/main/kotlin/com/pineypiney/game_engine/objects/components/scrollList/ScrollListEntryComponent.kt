...
abstract class ScrollListEntryComponent(parent: GameObject): DefaultInteractorComponent(parent, "SLE"){
        ...
        fun makeScrollerText(
            ...
            return object : MenuItem(){
                override fun addComponents() {
                    super.addComponents()
                    val x = this
                    components.add(object : TextRendererComponent(x, Text(text, colour, maxWidth, maxHeight, font, italic, underlineThickness, underlineOffset, underlineAmount, fontSize, alignment), shader){
                        override fun setUniforms() {
                            super.setUniforms()
                            uniforms.setVec2Uniform("limits", parent.parent!!.parent!!.getComponent<ScrollListComponent>()!!::limits)
                        }
                    })
                }
            }
