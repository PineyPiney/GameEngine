...
open class ColouredSpriteComponent(
	parent: GameObject,
	sprite: Sprite = Sprite(Texture2D.missing, 100f),
	...
	constructor(parent: GameObject, texture: Texture2D, ppu: Float, tint: Vec4 = Vec4(1f), shader: RenderShader = colouredMenuShader, setUniforms: ColouredSpriteComponent.() -> Unit = {}) :
