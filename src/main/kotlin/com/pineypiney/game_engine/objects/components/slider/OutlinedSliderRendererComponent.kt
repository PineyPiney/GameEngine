...
open class OutlinedSliderRendererComponent(parent: GameObject): RenderedComponent(parent, sliderShader) {
    ...
    override val shape: Shape = VertexShape.cornerSquareShape.shape
