...
class ColourSlider(size: Vec2, override val shader: Shader, val uniforms: (Shader) -> Unit, val action: (Int) -> Unit) : Slider(size, 0f, 255f, 255f) {

    override val pointer: ColourSliderPointer = ColourSliderPointer(this, size * Vec2((size.y / size.x) * (SliderPointer.pointerTexture.aspectRatio / Window.INSTANCE.aspectRatio) , 1))
