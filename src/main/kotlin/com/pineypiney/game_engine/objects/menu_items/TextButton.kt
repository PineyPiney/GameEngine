...
open class TextButton(val string: String, override val origin: Vec2, final override val size: Vec2, window: Window, textColour: Vec4 = Vec4(0, 0, 0, 1), override val action: (button: AbstractButton) -> Unit) : AbstractButton() {
