...
class ArrayTooSmallException : Exception {

	/**
	 * Constructs a `ArrayTooSmallException` with the specified detail message.
	 *
	 * @param message
	 * The detail message
	 */
	...
	/**
	 * Constructs a `ArrayTooSmallException` with the specified cause and a
