...
class ModelParseException: IOException {

    /**
     * Constructs a `ModelParseException` with the specified detail message.
     *
     * @param message
     * The detail message
     */
    ...
    /**
     * Constructs a `ModelParseException` with the specified cause and a
