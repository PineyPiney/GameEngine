...
class VertexAttribute<T, P>(
	...
	companion object {
		val POSITION = VertexAttribute("Position", Parent.POSITION, 3, GL11C.GL_FLOAT, ByteBuffer::getVec3, ByteBuffer::put, ::Vec3, ::Vec3, ::Vec3)
		val POSITION2D = VertexAttribute("Position2D", Parent.POSITION, 2, GL11C.GL_FLOAT, ByteBuffer::getVec2, ByteBuffer::put, ::Vec2, ::Vec2) { p, t -> Vec3(t, p.z) }

		val TEX_COORD = VertexAttribute("TexCoord", Parent.TEXTURE, 2, GL11C.GL_FLOAT, ByteBuffer::getVec2, ByteBuffer::put, ::Vec2, ::Vec2) { p, t -> Vec3(t, p.z) }
		...
		val COLOUR = VertexAttribute("Colour", Parent.COLOUR, 4, GL11C.GL_FLOAT, ByteBuffer::getVec4, ByteBuffer::put, { Vec4(1f) }, ::Vec4, ::Vec4)
		val COLOUR_BYTES =
			VertexAttribute("Colour Bytes", Parent.COLOUR, 4, GL11C.GL_UNSIGNED_BYTE, ByteBuffer::getVec4ub, ByteBuffer::put, { Vec4ub(255) }, { Vec4(it) / 255f }, { Vec4ub(it * 255f) })

		val NORMAL = VertexAttribute("Normal", Parent.NORMAL, 3, GL11C.GL_FLOAT, ByteBuffer::getVec3, ByteBuffer::put, { normal }, ::Vec3, ::Vec3)
		val TANGENT = VertexAttribute("Tangent", Parent.TANGENT, 3, GL11C.GL_FLOAT, ByteBuffer::getVec3, ByteBuffer::put, { Vec3(1f, 0f, 0f) }, ::Vec4, ::Vec3)
		val TANGENT_HANDED = VertexAttribute("Tangent", Parent.TANGENT, 4, GL11C.GL_FLOAT, ByteBuffer::getVec4, ByteBuffer::put, { Vec4(1f, 0f, 0f, 0f) }, ::Vec4, ::Vec4)

		val BONE_IDS = VertexAttribute("BoneIds", Parent.BONE_IDS, 4, GL11C.GL_INT, ByteBuffer::getVec4i, ByteBuffer::put, { Vec4i(-1) }, ::Vec4i, ::Vec4i)
		val BONE_WEIGHTS = VertexAttribute("BoneWeights", Parent.BONE_WEIGHTS, 4, GL11C.GL_FLOAT, ByteBuffer::getVec4, ByteBuffer::put, ::Vec4, ::Vec4, ::Vec4)
	}
