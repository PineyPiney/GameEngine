...
class PointLight(override val ambient: Vec3 = Vec3(0.1f), override val diffuse: Vec3 = Vec3(0.5f), override val specular: Vec3 = Vec3(1f), val constant: Float = 1f, val linear: Float = .09f, val quadratic: Float = .032f): Light() {
