...
class Uniforms(val uniforms: Array<Uniform<*>>) {
	...
	inline fun <reified U : Uniform<E>, E : Any> set(name: String, noinline getter: (RendererI) -> E?) {
	...
	inline fun <reified U : Uniform<E>, E : Any> set(name: String, noinline getter: () -> E?) {
		val uniform = this[name] ?: return
		if (uniform is U) {
			uniform.getter = { getter() }
		}
