...
class Uniforms(val uniforms: Array<Uniform<*>>) {
    ...
    fun setVec2Uniform(name: String, getter: () -> Vec2){
        val uniform = uniforms.firstOrNull{it.name == name} ?: return
    ...
    fun setVec2sUniform(name: String, getter: () -> Array<Vec2>){
        val uniform = uniforms.firstOrNull{it.name == name} ?: return
    ...
    fun setVec3Uniform(name: String, getter: () -> Vec3){
        val uniform = uniforms.firstOrNull{it.name == name} ?: return
    ...
    fun setVec3sUniform(name: String, getter: () -> Array<Vec3>){
        val uniform = uniforms.firstOrNull{it.name == name} ?: return
    ...
    fun setVec4Uniform(name: String, getter: () -> Vec4){
        val uniform = uniforms.firstOrNull{it.name == name} ?: return
    ...
    fun setVec4sUniform(name: String, getter: () -> Array<Vec4>){
        val uniform = uniforms.firstOrNull{it.name == name} ?: return
