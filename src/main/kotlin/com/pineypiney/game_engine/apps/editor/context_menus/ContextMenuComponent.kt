package com.pineypiney.game_engine.apps.editor.context_menus
...
class ContextMenuComponent<C>(parent: GameObject, val context: C, val menu: ContextMenu<C>): DefaultInteractorComponent(parent, "CMN") {
