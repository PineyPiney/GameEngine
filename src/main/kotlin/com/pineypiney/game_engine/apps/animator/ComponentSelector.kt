...
class ComponentSelector(item: GameObject?, origin: Vec2, size: Vec2, pred: Component.() -> Unit) : MenuItem() {
    ...
    class ComponentSelectorComponent(parent: GameObject, item: GameObject?, pred: Component.() -> Unit): SelectableScrollListComponent(parent) {
    ...
    class ComponentSelectorEntry(parent: GameObject, val c: String, override val index: Int) : SelectableScrollListEntryComponent(parent){
