...
fun Int.logInitError(severity: KLogger.(String) -> Unit = KLogger::info) = logError(VR::VR_GetVRInitErrorAsEnglishDescription, severity)

fun Int.logCompositorError(severity: KLogger.(String) -> Unit = KLogger::info) = logError(VRCompositorErrorMessages::get, severity)

fun Int.logInputError(severity: KLogger.(String) -> Unit = KLogger::info) = logError(VRInputErrorMessages::get, severity)
