...
abstract class WindowedGameEngine<E: WindowGameLogic>(resourcesLoader: ResourcesLoader): GameEngine<E>(resourcesLoader), WindowedGameEngineI<E> {
    ...
    override fun init(){
        ...
        activeScreen.updateAspectRatio(window)
